...
@RestController @RequestMapping("/api/auth/onboarding/owner") @RequiredArgsConstructor
public class OwnerOnboardingController {
    private final OwnerOnboardingService service;

    @PostMapping("/store")
    public ResponseEntity<OwnerStoreCreateResponse> register(@AuthenticationPrincipal Long userId,
