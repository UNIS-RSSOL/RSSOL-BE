package com.rssolplan.api.domain.payroll.util;

import java.time.Duration;
import java.time.LocalDateTime;
import java.time.LocalTime;

import static com.rssolplan.api.domain.payroll.util.LaborLawConstants.NIGHT_END;
import static com.rssolplan.api.domain.payroll.util.LaborLawConstants.NIGHT_START;
