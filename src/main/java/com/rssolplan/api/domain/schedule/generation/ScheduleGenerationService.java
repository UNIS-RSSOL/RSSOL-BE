...
import com.rssolplan.api.domain.schedule.generation.entity.ScheduleRequest.ScheduleRequestStatus;
import com.rssolplan.api.domain.schedule.generation.entity.WorkShift;
import com.rssolplan.api.domain.schedule.generation.strategy.*;
import com.rssolplan.api.domain.schedule.workavailability.WorkAvailability;
import com.rssolplan.api.domain.schedule.workavailability.WorkAvailabilityRepository;
import com.rssolplan.api.domain.schedule.workshifts.WorkShiftRepository;
...
import com.rssolplan.api.domain.store.setting.StoreSetting;
import com.rssolplan.api.domain.store.setting.StoreSettingRepository;
import com.rssolplan.api.domain.store.setting.StoreSettingSegment;
...
import static com.rssolplan.api.domain.store.UserStore.Position.OWNER;
